        ...
        t(".cart-link").click(function () {
            ...
            a > 1
                ? t.get(e + ",,," + a, function (e) {
                      e.message
                          ? (toastr.success(e.message), t(".cart-amount").val(1), t("#cartIconWrapper").load(location.href + " #cartIconWrapper"))
                          : (toastr.error(e.error), t(".cart-amount").val(1), t("#cartIconWrapper").load(location.href + " #cartIconWrapper"));
                  })
                : t.get(e, function (e) {
                        ...
                        success: function (a) {
                            if ((console.log(a), a.message)) {
                                ...
                                t(".cart_price span").each(function () {
                                    ...
                                    a.count && (t(".cart-item-view").text(a.count), t(".cart-total-view").text(("left" == position ? symbol + " " : "") + a.total + ("right" == position ? " " + symbol : ""))),
                                    t("#cartIconWrapper").load(location.href + " #cartIconWrapper");
                                    t('#cart_quantity_total').val(a.count);
                                    t('#update_cart_message').hide();
