  ...
  ******************************************************/
  $(".editbtn").on('click', function () {
    ...
    for (let x in datas) {
      ...
      if ($('.edit_summernote'+x).hasClass('summernote')) {
          $('.edit_summernote'+x).summernote('code', datas[x]);
      }

      if ($("#in" + x).find('textarea').hasClass('summernote')) {
        $("#in" + x).find('textarea').summernote('code', datas[x]);
