...
class PackageController extends Controller
{
  ...
  public function store(Request $request)
  {
    ...
    // $package->entrance_fee = $request->entrance_fee;
    $package->document_copy = $request->document_copy;
    $package->eligible = $request->eligible;
    ...
    $package->is_upgrade = ($request->is_upgrade == 'yes') ? true : false;
  ...
  public function update(Request $request)
  {
    ...
    $package->price = $request->price;
    $package->extend_fee = $request->extend_fee;
    $package->upgrade_fee = $request->upgrade_fee;
    $package->notes = $request->notes;
    // $package->entrance_fee = $request->entrance_fee;
    $package->document_copy = $request->document_copy;

    $package->document_copy_field = collect(explode(',', $request->document_copy))->map(function ($item) {
  ...
  public function packageStatus(Request $request)
  {
    ...
    if ($request->status == 1) {
      ...
      Session::flash('success', 'Unstatus successfully!');
    }
