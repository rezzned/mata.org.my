...
class ProductController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if ($bex->catalog_mode == 0) {
            ...
            $rules['assoc_price'] = 'required|numeric';
            $rules['stand_price'] = 'required|numeric';
        ...
        $product->postal_fee = $request->postal_fee;
        $product->save();
    ...
    public function update(Request $request)
    {
        ...
        // $in['postal_fee'] = (int)$request->postal_fee;
        $in['description'] = str_replace(url('/') . '/assets/front/img/', "{base_url}/assets/front/img/", $request->description);
        ...
        $product->postal_fee = (int)$request->postal_fee;
        $product->save();
