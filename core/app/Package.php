...
{
  protected $fillable = [
    'title', 'language_id', 'price', 'description',
    'serial_number', 'meta_keywords', 'meta_description',
    'color', 'order_status', 'link', 'image', 'feature', 'duration', 'category_id',
    'sub_title','eligibility','entrance_fee','document_copy_field', 'is_upgrade',
    'extend_fee', 'upgrade_fee', 'notes'
  ];
