          ...
          <div class="col-lg-6 offset-lg-3">
            ...
            >
              ...
              <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control ltr" name="previous_price" placeholder="Enter Previous Price" value="{{ $course->previous_price }}">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control ltr" name="current_price" placeholder="Enter Non-Member Price" value="{{ $course->previous_price }}"/>
                        <p class="mb-0 text-danger em"></p>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control ltr" name="assoc_price" placeholder="Enter Associate Member Price" value="{{ $course->assoc_price }}"/>
                        <p class="mb-0 text-danger em"></p>
                        <p class="mb-0 text-warning">Leave it blank if it is a free course</p>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control ltr" name="stand_price" placeholder="Enter Standard Member Price" value="{{ $course->stand_price }}"/>
                        <p class="mb-0 text-danger em"></p>
                        <p class="mb-0 text-warning">Leave it blank if it is a free course</p>
                    </div>
                </div>
              ...
              <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control ltr" name="duration" placeholder="eg: 10h 15m" value="{{ $course->duration }}"/>
              ...
              <div class="form-group mb-1">
                ...
                <input type="text" class="form-control ltr" name="video_link" placeholder="Enter YouTube Video Link" value="{{ $course->video_link }}"/>
