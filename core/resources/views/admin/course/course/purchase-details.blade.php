            ...
            <div class="modal-body">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-8">{{convertUtf8($purchase->user->username ?? "N/A")}}</div>
                    </div>
                    <hr>
                    <div class="row">
                        <div class="col-lg-4">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-8">{{convertUtf8($purchase->course->title ?? 'Deleted')}}</div>
                    </div>
                    <hr>
                    <div class="row">
                        <div class="col-lg-4">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-8">
                            <form action="{{ asset('assets/front/invoices/course/' . $purchase->invoice) }}" method="get">
