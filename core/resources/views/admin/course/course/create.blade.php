          ...
          <div class="col-lg-6 offset-lg-3">
            ...
            >
              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <select id="course_category_id" class="form-control" name="course_category_id" disabled/>
              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control ltr" name="duration" placeholder="eg: 10h 15m"/>
              ...
              <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control ltr" name="previous_price" placeholder="Enter Previous Price" value=""/>
                        <p class="mb-0 text-danger em"></p>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="">Non-Member Price ({{$bex->base_currency_text}})</label>
                        <input type="number" class="form-control ltr" name="current_price" placeholder="Enter Non-Member Price" value=""/>
                        <p class="mb-0 text-danger em"></p>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="">Associate Member Price ({{$bex->base_currency_text}})</label>
                        <input type="number" class="form-control ltr" name="assoc_price" placeholder="Enter Associate Member Price" value=""/>
                        <p class="mb-0 text-danger em"></p>
                        <p class="mb-0 text-warning">Leave it blank if it is a free course</p>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="">Standard Member Price ({{$bex->base_currency_text}})</label>
                        <input type="number" class="form-control ltr" name="stand_price" placeholder="Enter Standard Member Price" value=""/>
                        <p class="mb-0 text-danger em"></p>
                        <p class="mb-0 text-warning">Leave it blank if it is a free course</p>
                    </div>
                </div>
              ...
              <div class="form-group">
                ...
                <textarea class="form-control" name="summary" rows="6" cols="80" placeholder="Enter Course Summary"></textarea>
                <p
                  class="mb-0 text-danger em"
                ></p>
              </div>
              ...
              <div class="form-group mb-1">
                ...
                <input type="text" class="form-control ltr" name="video_link" placeholder="Enter YouTube Video Link" value=""/>
                <p id="errvideo_link" class="mb-0 text-danger em"></p>
              </div>

              <div class="form-group">
                <label for="">Course Overview **</label>
                <textarea class="form-control summernote" name="overview" rows="8" cols="80" placeholder="Enter Overview"></textarea>
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="instructor_name" placeholder="Enter Instructor Name" value=""/>
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="instructor_occupation" placeholder="Enter Instructor Occupation" value=""/>
