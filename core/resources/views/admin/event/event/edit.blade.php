            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <a class="btn btn-info btn-sm float-right d-inline-block"
                        href="{{ route('admin.event.index') . '?language=' . request()->input('language') }}">
                        ...
                        <div class="col-lg-6 offset-lg-3">
                            ...
                            <form id="ajaxForm" class="" action="{{ route('admin.event.update') }}" method="post">
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <button id="chooseImage2" class="choose-image btn btn-primary" type="button"
                                                data-multiple="true" data-toggle="modal" data-target="#lfmModal2">Choose
                                                Images</button>
                                                    ...
                                                    <div class="modal-content">
                                                        <div class="modal-body p-0">
                                                            <iframe id="lfmIframe2"
                                                                src="{{ url('laravel-filemanager') }}?serial=2&event={{ $event->id }}"
                                ...
                                <div class="">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="short_form"
                                            value="{{ $event->short_form }}" placeholder="Enter short form">
                                            ...
                                            <select class="form-control" name="cat_id">
                                                ...
                                                @foreach ($event_categories as $key => $event_category)
                                                    <option value="{{ $event_category->id }}"
                                                        {{ $event_category->id == $event->eventCategories->id ? 'selected' : '' }}>
                                                        {{ $event_category->name }}
                                                    </option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control ltr" name="status">
                                                <option {{ $event->status == App\Event::STATUS_ACTIVE ? 'selected' : '' }}
                                                    value="{{ App\Event::STATUS_ACTIVE }}">{{ __('Active') }}</option>
                                                <option
                                                    {{ $event->status == App\Event::STATUS_DEACTIVE ? 'selected' : '' }}
                                                    value="{{ App\Event::STATUS_DEACTIVE }}">{{ __('Deactive') }}
                                                </option>
                                            </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" name="short_desc" rows="4" cols="80"
                                        placeholder="Enter short description">{{ $event->short_desc }}</textarea>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control ltr" name="date"
                                        value="{{ $event->date }}" placeholder="Enter Event Date">
                                    <p id="errdate" class="mb-0 text-danger em"></p>
                                </div>
                                <div class="form-group">
                                    <label for="">Time</label>
                                    <input type="time" class="form-control ltr" name="time"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="datetime-local" class="form-control ltr" name="datetime2"
                                        value="{{ $event->datetime2 ? \Carbon\Carbon::parse($event->datetime2)->format('Y-m-d H:i') : null }}"
                                ...
                                @php
                                    ...
                                    foreach ($event_ticket as $key => $value) {
                                        if ($value->type == App\EventTicket::NONE_MEMBER) {
                                            $none_member = $value;
                                        }
                                        if ($value->type == App\EventTicket::ASSOCIATE_MEMBER) {
                                            $associate_member = $value;
                                        }
                                        if ($value->type == App\EventTicket::STANDARD_MEMBER) {
                                            $standard_member = $value;
                                        }
                                    }
                                @endphp

                                <input type="hidden" name="none_member_id"
                                    value="{{ $none_member ? $none_member->id : '' }}">
                                <input type="hidden" name="associate_member_id"
                                    value="{{ $associate_member ? $associate_member->id : '' }}">
                                <input type="hidden" name="standard_member_id"
                                    value="{{ $standard_member ? $standard_member->id : '' }}">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-4">
                                            <div class="form-group">
                                                ...
                                                <input type="hidden" class="form-control ltr" min='0'
                                                    name="ticket_type[]" value="{{ App\EventTicket::NONE_MEMBER }}">
                                            </div>
                                        </div>
                                        <div class="col-sm-4">
                                            <div class="form-group">
                                                <label for="">Available Tickets **</label>
                                                <input type="number" class="form-control ltr" min='0'
                                                    name="available_tickets[]"
                                                    value="{{ $none_member ? $none_member->available : '' }}"
                                                    placeholder="Enter Available Tickets Number" required>
                                            </div>
                                        </div>
                                        <div class="col-sm-4">
                                            <div class="form-group">
                                                <label for="">Cost (in {{ $abx->base_currency_text }}) **</label>
                                                <input type="number" class="form-control ltr" name="cost[]"
                                                    value="{{ $none_member ? $none_member->cost : '' }}"
                                                    placeholder="Enter Ticket Cost" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-sm-4">
                                            <div class="form-group">
                                                ...
                                                <input type="hidden" class="form-control ltr" min='0'
                                                    name="ticket_type[]" value="{{ App\EventTicket::ASSOCIATE_MEMBER }}">
                                            </div>
                                        </div>
                                        <div class="col-sm-4">
                                            <div class="form-group">
                                                <input type="number" class="form-control ltr" min='0'
                                                    name="available_tickets[]"
                                                    value="{{ $associate_member ? $associate_member->available : '' }}"
                                                    placeholder="Enter Available Tickets Number" required>
                                            </div>
                                        </div>
                                        <div class="col-sm-4">
                                            <div class="form-group">
                                                <input type="number" class="form-control ltr" name="cost[]"
                                                    value="{{ $associate_member ? $associate_member->cost : '' }}"
                                                    placeholder="Enter Ticket Cost" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-sm-4">
                                            <div class="form-group">
                                                ...
                                                <input type="hidden" class="form-control ltr" min='0'
                                                    name="ticket_type[]" value="{{ App\EventTicket::STANDARD_MEMBER }}">
                                            </div>
                                        </div>
                                        <div class="col-sm-4">
                                            <div class="form-group">
                                                <input type="number" class="form-control ltr" min='0'
                                                    name="available_tickets[]"
                                                    value="{{ $standard_member ? $standard_member->available : '' }}"
                                                    placeholder="Enter Available Tickets Number" required>
                                            </div>
                                        </div>
                                        <div class="col-sm-4">
                                            <div class="form-group">
                                                <input type="number" class="form-control ltr" name="cost[]"
                                                    value="{{ $standard_member ? $standard_member->cost : '' }}"
                                                    placeholder="Enter Ticket Cost" required>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control ltr" name="organizer"
                                        value="{{ $event->organizer }}" placeholder="Event Organizer">
                                    <p id="errorganizer" class="mb-0 text-danger em"></p>
                                </div>
                                <div class="form-group">
                                    <label for="">Organizer Email</label>
                                    <input type="text" class="form-control ltr" name="organizer_email"
                                        value="{{ $event->organizer_email }}" placeholder="Organizer Email">
                                    <p id="errorganizer_email" class="mb-0 text-danger em"></p>
                                </div>
                                <div class="form-group">
                                    <label for="">Organizer Phone</label>
                                    <input type="text" class="form-control ltr" name="organizer_phone"
                                        value="{{ $event->organizer_phone }}" placeholder="Organizer Phone">
                                    <p id="errorganizer_phone" class="mb-0 text-danger em"></p>
                                </div>
                                <div class="form-group">
                                    <label for="">Organizer Website</label>
                                    <input type="text" class="form-control ltr" name="organizer_website"
                                        value="{{ $event->organizer_website }}" placeholder="Organizer Website">
                                    <p id="errserial_number" class="mb-0 text-danger em"></p>
                                </div>
                                <div class="form-group">
                                    <label for="">Venue</label>
                                    <input type="text" class="form-control ltr" name="venue"
                                        value="{{ $event->venue }}" placeholder="Enter Venue">
                                    <p id="errvenue" class="mb-0 text-danger em"></p>
                                </div>
                                <div class="form-group">
                                    <label for="">Venue Location</label>
                                    <input type="text" class="form-control ltr" name="venue_location"
                                        value="{{ $event->venue_location }}" placeholder="Venue Location">
                                    <p id="errvenue_location" class="mb-0 text-danger em"></p>
                                </div>
                                <div class="form-group">
                                    <label for="">Venue Phone</label>
                                    <input type="text" class="form-control ltr" name="venue_phone"
                                        value="{{ $event->venue_phone }}" placeholder="Venue Phone">
                                    <p id="errvenue_phone" class="mb-0 text-danger em"></p>
                                </div>
                                <div class="form-group">
                                    <label for="">CPD Points</label>
                                    <input type="text" class="form-control ltr" name="cpd_points"
                                        value="{{ $event->cpd_points ?? 0 }}" placeholder="CPD points">
                                    <p id="errcpd_points" class="mb-0 text-danger em"></p>
                                </div>
                                <div class="form-group">
                                    <label for="">Meta Keywords</label>
                                    <input type="text" class="form-control" name="meta_tags"
                                        value="{{ $event->meta_tags }}" data-role="tagsinput">
                                ...
                                <div class="form-group">
                                    ...
                                    <label for="">QRcode Attendance</label>
                                    <div class="col-md-12">

                                        {{-- <a href="{{asset('assets/qrcode/'.$event->id.'QrCode.svg')}}" class="btn btn-primary" download>Download</a><br> --}}
                                        <img class="img-thumbnail"
                                            src="{{ asset('assets/qrcode/' . $event->id . 'QRCode.svg') }}" width="150"
                                            height="150" style="margin-top: 20px">
                                    </div>
...
@section('scripts')
    ...
    <script>
        ...
        $('#qrcode-link').click(function(e) {
            e.preventDefault();
            var qrCodeSrc = $(this).children('img').attr('src');
            $('#modal-qrcode').attr('src', qrCodeSrc);
            $('#download-link').attr('href', qrCodeSrc);
        });
    </script>
@endsection
