                     ...
                     <table class="table table-striped mt-3" id="basic-datatables">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><span title="{{ convertUtf8($event->title) }}">{{ Str::limit(convertUtf8($event->title), 30) }}</span></td>
                                <td><small>{!! $event->pricing !!}</small></td>
                                <td>{{$event->cpd_points ?? '0'}}</td>
                                @php($date = \Carbon\Carbon::parse($event->date))
                                <td>{{$date->translatedFormat('jS F, Y')}}</td>
                                <td nowrap>
                                    <span id="status_badge{{$event->id}}">
                                        @if ($event->status == App\Event::STATUS_ACTIVE)
                                          <span class="badge badge-success">{{__('Active')}}</span>
                                        @elseif ($event->status == App\Event::STATUS_DEACTIVE)
                                          <span class="badge badge-danger">{{__('Deactive')}}</span>
                                        @endif
                                        <button class="btn btn-sm py-1 px-2 btn-dark btn-rounded" onclick="window.event_status_form{{$event->id}}.style.display='block';window.status_badge{{$event->id}}.style.display='none'">
                                            <i class="fa fa-edit"></i>
                                        </button>
                                    </span>
                                    <form action="{{route('admin.event.update_status', $event->id)}}" id="event_status_form{{$event->id}}" method="POST" style="display: none" onsubmit="return confirm('Are you sure?')"> @csrf
                                        <select class="form-control form-control-sm d-inline mr-1" name="status" id="status_update{{$event->id}}" onchange="window.event_status_form{{$event->id}}.submit()">
                                            <option value="{{App\Event::STATUS_ACTIVE}}" @if ($event->status == App\Event::STATUS_ACTIVE) selected @endif>{{__('Active')}}</option>
                                            <option value="{{App\Event::STATUS_DEACTIVE}}" @if ($event->status == App\Event::STATUS_DEACTIVE) selected @endif>{{__('Deactive')}}</option>
                                        </select>
                                        <button type="button" class="btn btn-sm py-1 px-2 btn-danger d-inline" onclick="window.event_status_form{{$event->id}}.style.display='none';window.status_badge{{$event->id}}.style.display='inline'">
         ...
         <div class="modal-body">
            ...
            <form id="ajaxForm" class="modal-form" action="{{route('admin.event.store')}}" method="POST">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="form-group">
                            ...
                            <br>
                            <div class="slider-thumbs" id="sliderThumbs1"></div>
               ...
               <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="short_form" placeholder="Enter short form" value="" required>
               ...
               <div class="form-group">
                  ...
                  <textarea class="form-control" name="short_desc" rows="4" cols="80" placeholder="Enter short description"></textarea>
               ...
               <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="datetime-local" class="form-control ltr" name="datetime2" value="" placeholder="Enter Event Date and Time">
               ...
               <div class="form-group">
                    <div class="row">
                        <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                <input type="hidden" class="form-control ltr" name="ticket_type[]" value="{{App\EventTicket::NONE_MEMBER}}">
                            </div>
                        </div>
                        <div class="col-sm-4">
                            <div class="form-group">
                    ...
                    <div class="row">
                        <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                <input type="hidden" class="form-control ltr" name="ticket_type[]" value="{{App\EventTicket::ASSOCIATE_MEMBER}}">
                            </div>
                        </div>
                        <div class="col-sm-4">
                            <div class="form-group">
                    ...
                    <div class="row">
                        <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                <input type="hidden" class="form-control ltr" name="ticket_type[]" value="{{App\EventTicket::STANDARD_MEMBER}}">
                            </div>
                        </div>
                        <div class="col-sm-4">
                            <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control ltr" name="organizer_phone" value="" placeholder="Organizer Phone">
                ...
                <div class="form-group">
                    ...
                    <input type="number" min="0" class="form-control ltr" name="cpd_points" value="" placeholder="CPD Points">
                    <p id="errvenue_phone" class="mb-0 text-danger em"></p>
                </div>
               <div class="form-group">
