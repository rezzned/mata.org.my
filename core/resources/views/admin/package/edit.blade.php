  ...
  <div class="col-md-12">
    <div class="card">
      <div class="card-header">
        <div class="card-title d-inline-block">Edit Membership</div>
          ...
          <div class="col-lg-6 offset-lg-3">
            ...
            <form id="ajaxForm" class="modal-form" action="{{route('admin.package.update')}}" method="POST">
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control ltr" name="extend_fee" placeholder="Enter extend price" 
                value="{{$package->extend_fee}}" />
                <p id="errextendfee" class="mb-0 text-danger em"></p>
              </div>
              <div class="form-group">
                <label for="">Upgrade Price (in {{$abx->base_currency_text}}) **</label>
                <input type="text" class="form-control ltr" name="upgrade_fee" placeholder="Enter upgrade price" 
                value="{{$package->upgrade_fee}}" />
                <p id="errextendfee" class="mb-0 text-danger em"></p>
              </div>
              {{-- <div class="form-group">
                ...
                <input type="text" class="form-control" name="entrance_fee" placeholder="Enter entrance fee"
                  value="{{$package->entrance_fee}}">
                <p id="errentrance_fee" class="mb-0 text-danger em"></p>
              </div> --}}

              <div class="form-group">
                <label for="">Eligible</label>
                <textarea class="form-control" name="eligible" rows="3" placeholder="Enter eligible">{{replaceBaseUrl($package->eligible)}}</textarea>
              </div>
              <div class="form-group">
                <label for="">Document Copy **</label>
                <input class="form-control" name="document_copy" value="{{$package->document_copy}}" placeholder="Enter document copy"
                data-role="tagsinput">
                <p id="errdocument_copy" class="mb-0 text-danger em"></p>
              </div>
              <div class="form-group">
                <label for="">Notes</label>
                <textarea class="form-control" name="notes" rows="3" placeholder="Enter notes">{{replaceBaseUrl($package->notes)}}</textarea>
              ...
              <div class="form-group">
                ...
                <div class="custom-control custom-radio custom-control-inline">
                  <input type="radio" name="is_upgrade" id="is_upgrade_yes" {{ $package->is_upgrade == 1 ? 'checked' : ''}} />
                  <label for="is_upgrade_yes">Yes</label>
                </div>
                <div class="custom-control custom-radio custom-control-inline">
                  <input type="radio" name="is_upgrade" id="is_upgrade_no" {{ $package->is_upgrade == 0 ? 'checked' : ''}} />
