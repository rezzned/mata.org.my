...
<div class="page-header">
  ...
  <ul class="breadcrumbs">
    ...
    <li class="nav-item">
      <a href="#">Membership Management</a>
    </li>
    <li class="separator">
      <i class="flaticon-right-arrow"></i>
    </li>
  ...
  <div class="col-md-12">
    <div class="card">
      <div class="card-header">
        <div class="row">
          <div class="col-lg-4">
            <div class="card-title d-inline-block">Membership</div>
          </div>
          <div class="col-lg-3">
            @if (!empty($langs))
          ...
          <div class="col-lg-4 offset-lg-1 mt-2 mt-lg-0">
            {{-- <a href="#" class="btn btn-primary float-lg-right float-left btn-sm" data-toggle="modal"
              data-target="#createModal"><i class="fas fa-plus"></i> Add Membership</a> --}}
              ...
              <table class="table table-striped mt-3" id="basic-datatables">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      <form id="featureForm{{$package->id}}" class="d-inline-block"
                        ...
                        <select class="form-control {{$package->feature == 1 ? 'bg-success' : 'bg-danger'}}"
                          name="feature" onchange="this.form.submit()">
                    ...
                    <td>
                      <form id="featureForm{{$package->id}}" class="d-inline-block"
                        action="{{route('admin.package.status')}}" method="post">
                        @csrf
                        <input type="hidden" name="package_id" value="{{$package->id}}">
                        <select class="form-control {{$package->status == 1 ? 'bg-success' : 'bg-danger'}}"
                          name="status" onchange="this.form.submit()">
                          <option value="1" {{$package->status == 1 ? 'selected' : ''}}>Yes</option>
                          <option value="0" {{$package->status == 0 ? 'selected' : ''}}>No</option>
                        </select>
                      </form>
                    </td>
...
<div class="modal fade" id="createModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
  ...
  <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLongTitle">Add Membership</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
        ...
        <form id="ajaxForm" class="modal-form" action="{{route('admin.package.store')}}" method="POST">
          ...
          <div class="row">
            ...
            <div class="{{$be->theme_version == 'cleaning' ? 'col-lg-6' : 'col-lg-12'}}">
              <div class="form-group">
                <label for="">Extend Price (in {{$abx->base_currency_text}}) **</label>
                <input type="text" class="form-control ltr" name="extend_fee" placeholder="Enter extend price" value="">
                <p id="errextendfee" class="mb-0 text-danger em"></p>
              </div>
            </div>
          ...
          {{-- <div class="form-group">
            <label for="">Entrance Fee (in {{$abx->base_currency_text}})</label>
            <input type="text" class="form-control" name="entrance_fee" placeholder="Enter entrance fee"
              value="">
            <p id="errentrance_fee" class="mb-0 text-danger em"></p>
          </div> --}}
          <div class="form-group">
            <label for="">Eligible</label>
            <textarea class="form-control" name="eligible" rows="3" placeholder="Enter eligible"></textarea>
          </div>
          <div class="form-group">
            <label for="">Document Copy</label>
            <input class="form-control" name="document_copy" value="" placeholder="Enter document copy"
            data-role="tagsinput">
            {{-- <textarea class="form-control" name="document_copy" rows="3" placeholder="Enter document copy"></textarea> --}}
            <p id="errdocument_copy" class="mb-0 text-danger em"></p>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="custom-control custom-radio custom-control-inline">
              <input type="radio" name="is_upgrade" value="yes" id="is_upgrade_yes" />
              <label for="is_upgrade_yes">Yes</label>
            </div>
            <div class="custom-control custom-radio custom-control-inline">
              <input type="radio" name="is_upgrade" value="no" id="is_upgrade_no" checked />
              <label for="is_upgrade_no">No</label>
            </div>
          </div>
        </form>
      </div>
