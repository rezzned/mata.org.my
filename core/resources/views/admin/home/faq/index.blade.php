      ...
      <div class="modal-body">
        <form id="ajaxForm" class="modal-form create" action="{{route('admin.faq.store')}}" method="POST">
          ...
          <div class="form-group">
            ...
            <textarea class="summernote" data-height="200" name="answer" placeholder="Enter answer"></textarea>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="ajaxEditForm" class="" action="{{route('admin.faq.update')}}" method="POST">
          ...
          <div class="form-group">
            <label for="">Answer **</label>
            <textarea id="inanswer" class="edit_summernoteanswer summernote" data-height="200" name="answer" placeholder="Enter answer"></textarea>
