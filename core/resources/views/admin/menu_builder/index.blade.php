                        ...
                        <div class="card border-primary mb-3">
                            ...
                            <div class="card-body">
                                <ul class="list-group">
                                    ...
                                    <li class="list-group-item">{{__('Membership')}} <a data-text="{{__('Membership')}}" data-type="packages" class="addToMenus btn btn-primary btn-sm float-right" href="">Add to Menus</a></li>
                                    {{-- <li class="list-group-item">
                                        {{__('Portfolios')}}
                                        <span class="badge badge-dark">Non Mega Menu</span>
                                    ...
                                    <li class="list-group-item">{{__('Council Members')}} <a data-text="{{__('Council Members')}}" data-type="team" class="addToMenus btn btn-primary btn-sm float-right" href="">Add to Menus</a></li>
                                    ...
                                    @if ($bex->is_event == 1)
                                        ...
                                        <li class="list-group-item">
                                            {{__('Trainings')}}
                                            <span class="badge badge-dark">Non Mega Menu</span>
                                            <a data-text="{{__('Trainings')}}" data-type="events" class="addToMenus btn btn-primary btn-sm float-right" href="">Add to Menus</a>
                                        </li>
                                        <li class="list-group-item">
                                            {{__('Trainings')}}
                                            <span class="badge badge-danger">Mega Menu</span>
                                            <a data-text="{{__('Trainings')}}" data-type="events-megamenu" class="addToMenus btn btn-primary btn-sm float-right" href="">Add to Menus</a>
                                        </li>
                                    @endif
                                    ...
                                    @if ($bex->is_shop == 1)
                                        ...
                                        <li class="list-group-item">
                                            {{__('Publications')}}
                                            <span class="badge badge-danger">Mega Menu</span>
                                            <a data-text="{{__('Publications')}}" data-type="products-megamenu" class="addToMenus btn btn-primary btn-sm float-right" href="">Add to Menus</a>
                                        </li>
                                        <li class="list-group-item">
                                            {{__('Publications')}}
                                            <span class="badge badge-dark">Non Mega Menu</span>
                                            <a data-text="{{__('Publications')}}" data-type="products" class="addToMenus btn btn-primary btn-sm float-right" href="">Add to Menus</a>
                                        </li>
                                    @endif
