          ...
          <div class="row">
            <div class="col-lg-8 offset-lg-2">
                ...
                <form action="{{route('admin.megamenu.update')}}" id="megaMenuForm" method="POST">
                    ...
                    @if (($type == 'services' && serviceCategory($hbex)) || ($type == 'products') || ($type == 'portfolios' && serviceCategory($hbex)) || ($type == 'courses') || ($type == 'events') || ($type == 'blogs'))
                        @foreach ($cats as $cat)
                            @php
                                $type = request()->input('type');
                                if($type == 'services') {
                        ...
                        @endforeach
                    @elseif ((!serviceCategory($hbex) && $type == 'services') || (!serviceCategory($hbex) && $type == 'portfolios') || ($type == 'causes'))
                        <div class="form-group">
