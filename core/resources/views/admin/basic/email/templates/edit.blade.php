                ...
                <table class="table table-striped mb-5" style="border: 1px solid #0000005a;">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <th scope="row">
                              Expire Date of Currently Active Membership
                            </th>
                        </tr>
                        @endif

                        @if ($template->email_type == 'email_verified_by_admin' || $template->email_type == 'email_active_by_admin')
                        <tr>
                            <td>
                              {status}
                            </td>
                        ...
                        @endif
                        @if ($template->email_type == 'password_update_by_admin')
                        <tr>
                            <td>
                              {password}
                            </td>
              ...
              <form id="ajaxForm" action="{{route('admin.email.templateUpdate', $template->id)}}" method="post" enctype="multipart/form-data">
                ...
                @php
                    if ($template->email_type == 'package_order') {
                        $etype = "Membership Order (One Time)";
                    } else {
