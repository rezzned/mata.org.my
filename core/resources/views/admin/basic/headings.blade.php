...
{{--                  </div>--}}
                  ...
                  <div class="form-group col-lg-6">
                    <label>Publication Subtitle **</label>
                  ...
                  <div class="form-group col-lg-6">
                    <label>Publication Details Title **</label>
...
{{--                  </div>--}}
                  <div class="form-group col-lg-6">
                    <label>Training Programme Title **</label>
                  ...
                  <div class="form-group col-lg-6">
                    <label>Training Programme Subtitle **</label>
                  ...
                  <div class="form-group col-lg-6">
                    <label>Training Programme Details Title **</label>
...
{{--                  </div>--}}
                  ...
                  <div class="form-group col-lg-6">
                    <label>Council Member Title **</label>
                  ...
                  <div class="form-group col-lg-6">
                    <label>Council Member Subtitle **</label>
...
{{--                  </div>--}}
                  ...
                  <div class="form-group col-lg-6">
                    <label>Training Details Title **</label>
