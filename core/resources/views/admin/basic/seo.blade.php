        ...
        <form class="" action="{{route('admin.seo.update', $lang_id)}}" method="post">
          ...
          <div class="card-body pt-5 pb-5">
            <div class="row">
              ...
              <div class="col-lg-6">
                  <div class="form-group">
                    <label>Meta Keywords for Membership</label>
                  ...
                  <div class="form-group">
                    <label>Meta Description for Membership</label>
              ...
              <div class="col-lg-6">
                  <div class="form-group">
                    <label>Meta Keywords for Council Member Page</label>
                  ...
                  <div class="form-group">
                    <label>Meta Description for Council Member Page</label>
              ...
              <div class="col-lg-6">
                <div class="form-group">
                    <label>Meta Keywords for Training Programme Page</label>
                  ...
                  <div class="form-group">
                    <label>Meta Description for Training Programme Page</label>
              ...
              <div class="col-lg-6">
                <div class="form-group">
                    <label>Meta Keywords for Publications Page</label>
                  ...
                  <div class="form-group">
                    <label>Meta Description for Publications Page</label>
              ...
              <div class="col-lg-6">
                ...
                <div class="col-lg-6">
                    <div class="form-group">
                        <label>Meta Keywords for Training Events Page</label>
                        <input class="form-control" name="events_meta_keywords" value="{{$abe->events_meta_keywords}}"
                               placeholder="Enter meta keywords" data-role="tagsinput">
                    </div>
                    <div class="form-group">
                        <label>Meta Description for Training Events Page</label>
