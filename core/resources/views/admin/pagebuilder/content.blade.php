...
<html>
  ...
  <body>
    ...
    //   Featured Publication Categories Section
    @if(!empty($pcatsec))
    var blockManager = editor.BlockManager;
        blockManager.add('featured-product-categories', {
            label: 'Featured Publication Categories',
            attributes: {class:'fa fa-list'},
            content: {
                components: `{!! $pcatsec !!}`
            },
    ...
    var blockManager = editor.BlockManager;
        blockManager.add('featured-new-products', {
            label: 'Featured / New Publications',
    ...
    // Home Publication Categories Section
    @if(!empty($hcatsec))
    var blockManager = editor.BlockManager;
        blockManager.add('home-cat-products', {
            label: 'Publication Categories in Home',
            attributes: {class:'fa fa-list'},
            content: {
                components: `{!! $hcatsec !!}`
            },
