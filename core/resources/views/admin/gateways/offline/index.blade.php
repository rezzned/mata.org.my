                     ...
                     <table class="table table-striped mt-3">
                        <thead>
                           <tr>
                              ...
                              <th scope="col">Publication Checkout</th>
                              @endif
                              <th scope="col">Membership Checkout</th>
                        ...
                        <tbody>
                           ...
                           <tr>
                              ...
                              <td>
                               ...
                               {{--
                               <td>
                                   <form id="donationForm{{$ogateway->id}}" class="d-inline-block"
                                         action="{{route('admin.offline.status')}}" method="post">
                                       @csrf
                                       <input type="hidden" name="ogateway_id" value="{{$ogateway->id}}">
                                       <input type="hidden" name="type" value="donation">
                                       <select
                                           class="form-control form-control-sm {{$ogateway->donation_checkout_status == 1 ? 'bg-success' : 'bg-danger'}}"
                                           name="donation_checkout_status"
                                           onchange="document.getElementById('donationForm{{$ogateway->id}}').submit();">
                                           <option
                                               value="1" {{$ogateway->donation_checkout_status == 1 ? 'selected' : ''}}>
                                               Active
                                           </option>
                                           <option
                                               value="0" {{$ogateway->donation_checkout_status == 0 ? 'selected' : ''}}>
                                               Deactive
                                           </option>
                                       </select>
                                   </form>
