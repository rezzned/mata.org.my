...
<body data-background-color="dark">
    ...
    <script>
        $(document.body).on('submit', 'form', function(event) {
            ...
            if (!submit_btn.hasClass('disabled')) {
                ...
                submit_btn.addClass('disabled').append('<div class="ms-2 spinner-border spinner-border-sm" role="status"><span class="sr-only"></span></div>');
    ...
    @yield('scripts')
    <script async>console.clear();</script>
</body>
</html>
