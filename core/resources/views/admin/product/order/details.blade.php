...
<div class="row">
   ...
   <div class="col-lg-12">
    <div class="card">
       <div class="card-header">
          <h4 class="card-title">Order Publication</h4>
       </div>
       <div class="card-body">
             ...
             <table class="table table-bordered">
                ...
                <tbody>
                   ...
                   <tr>
                      ...
                      <td>{{$bex->base_currency_symbol_position == 'left' ? $bex->base_currency_symbol : ''}}{{$item->shipping_price}}{{$bex->base_currency_symbol_position == 'right' ? $bex->base_currency_symbol : ''}}</td>
