               ...
               <div class="col-lg-6 offset-lg-3">
                  <form id="settingsForm" class="" action="{{route('admin.product.settings')}}" method="post" enctype="multipart/form-data">
                     ...
                     <div class="form-group">
                        ...
                        <p class="text-warning mb-0">If you enable catalog mode, then pricing, cart, checkout option of publications will be removed. But publication & publication details page will remain.</p>
                     </div>
                     <div class="form-group">
