...
<div class="page-header">
   <h4 class="page-title">Choose Publication Type</h4>
   <ul class="breadcrumbs">
      ...
      <li class="nav-item">
         <a href="#">Publication Management</a>
      </li>
      <li class="separator">
         <i class="flaticon-right-arrow"></i>
      </li>
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col col-stats ml-3 ml-sm-0">
                                <div class="numbers mx-auto text-center">
                                    <h2 class="card-title mt-2 mb-4 text-uppercase">Digital Publication</h2>
                ...
                <div class="card card-stats card-round">
                    <div class="card-body ">
                        <div class="row align-items-center">
                            ...
                            <div class="col col-stats ml-3 ml-sm-0">
                                <div class="numbers mx-auto text-center">
                                    <h2 class="card-title mt-2 mb-4 text-uppercase">Physical Publication</h2>
