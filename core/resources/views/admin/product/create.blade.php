    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">
                <div class="card-title d-inline-block">Add Publication</div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control ltr" name="stock" value="" placeholder="Enter Publication Stock">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="sku" value="{{rand(1000000,9999999)}}"  placeholder="Enter Publication sku">
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control ltr" name="previous_price" min="0" step="any" value="" placeholder="Enter Previous Price">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control ltr" name="current_price" min="0" step="any" value=""  placeholder="Enter Price for Non-Members">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control ltr" name="assoc_price" min="0" step="any" value=""  placeholder="Enter Price for Associate Members">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control ltr" name="stand_price" min="0" step="any" value=""  placeholder="Enter Price for Standard Members">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control ltr" name="postal_fee" min="0" step="any" value=""  placeholder="Enter Postal Fee">
                                ...
                                @if ($type == 'physical')
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control ltr" name="shipping_price" min="0" step="any" value="" placeholder="Enter Shipping Price">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="form-group">
                                    ...
                                    <textarea name="summary" id="summary" class="form-control" rows="4" placeholder="Enter Publication Summary"></textarea>
