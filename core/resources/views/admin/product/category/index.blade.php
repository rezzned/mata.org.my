...
@section('content')
  <div class="page-header">
    <h4 class="page-title">Publication Categories</h4>
          ...
          <div class="row">
            <div class="col-lg-12">
              @if (count($pcategories) == 0)
                <h3 class="text-center">NO PUBLICATION CATEGORY FOUND</h3>
              @else
                  ...
                  <table class="table table-striped mt-3">
                    <thead>
                      <tr>
                        ...
                        <th scope="col">Publications in Home</th>
                        @endif
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLongTitle">Add Publication Category</h5>
