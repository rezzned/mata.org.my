...
@section('breadcrumb-link', __('Our Publication'))
            ...
            <div class="col-lg-3 col-md-6">
                <div class="shop-dropdown mt-30 text-right">
                    <select name="type" id="type_sort">
                        <option value="new" {{ request()->input('type') == 'new' ? 'selected' : '' }}>{{__('Newest Publication')}}</option>
                        <option value="old" {{ request()->input('type') == 'old' ? 'selected' : '' }}>{{__('Oldest Publication')}}</option>
            ...
            <div class="col-lg-3 col-md-5 col-sm-7 order-2 order-lg-1">
                <div class="shop-sidebar">
                    ...
                    <div class="shop-box shop-filter mt-30">
                        <div class="sidebar-title">
                            <h4 class="title">{{__('Filter Publications')}}</h4>
                        </div>
                            ...
                            @if ($bex->catalog_mode == 0)
                                <span>
                                    ...
                                    @if (!empty($product->previous_price))
                                        <del>  <span class="prepice"> {{currency_format($product->previous_price)}}</span></del>
                                    @endif
                                </span>
                            @endif
                        </div>
