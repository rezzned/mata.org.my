                    ...
                    <div class="row no-gutters">
                        <div class="col-lg-3">
                            <div class="form_group border-right">
                                <input type="text" class="form_control" name="title" placeholder="{{ __('Training Name') }}" value="{{ request()->input('title') }}">
                            </div>
                        </div>
                        <div class="col-lg-3">
                            <div class="form_group border-right">
                        ...
                        <div class="col-lg-2">
                            <div class="form_group">
                                <input type="date" name="date" placeholder="dd-mm-yyyy" class="form_control datepicker_class" value="{{ request()->input('date') }}" />
                            </div>
                        </div>
                        <div class="col-lg-2">
                            <div class="form_group">
                                <button class="main-btn" type="submit" style="height: 45px;justify-content: center;text-align: center;padding-top: 0;padding-bottom: 0;">{{ __('Search') }}</button>
                            </div>
                        </div>
            ...
            <div class="contact-form-section pt-0 pb-4">
                <div class="container">
                    <div class="row justify-content-center text-center">
                        <div class="col-lg-6">
                            <span class="section-title text-center">{{ __('Trainings') }}</span>
                    ...
                    @foreach ($events as $event)
                        <div class="col-lg-6 col-md-12 col-sm-12 grid-column cat1 cat4">
                            <div class="event-item">
                                <div class="event-img" style="width:190px">
                                    @php
                                ...
                                <div class="event-content" style="width:calc(100% - 190px)">
                                    <a class="cat c-1 base-bg text-white" href="{{ route('front.events', ['category' => $event->eventCategories->id]) }}">{{ $event->eventCategories->name }}</a>
                                    {{-- <a class="cat c-1" >
                                    ...
                                    <p class="event-summery">{{ Str::limit($event->short_desc, 60) }}</p>
