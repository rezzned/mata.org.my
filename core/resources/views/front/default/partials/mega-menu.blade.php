...
@php
    $catAvailable = true;
    if ($link["type"] == 'services-megamenu' && serviceCategory($hbex)) {
    ...
    } elseif ($link["type"] == 'portfolios-megamenu' && serviceCategory($hbex)) {
    ...
    } elseif ($link["type"] == 'services-megamenu' && !serviceCategory($hbex)) {
